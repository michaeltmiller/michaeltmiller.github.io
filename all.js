...
angular.module('hackApp', ['ui.router', 'ngSanitize', 'angularMoment']).config(function ($stateProvider, $urlRouterProvider) {
...
angular.module('hackApp').service('apiService', function ($http) {

	this.getTopStories = function () {
		return $http.get('http://node-hnapi.herokuapp.com/news').then(function (res) {
			console.log(res);
			return res.data;
		});
	};
	...
	this.getSingleStory = function (id) {
		return $http.get('http://node-hnapi.herokuapp.com/item/' + id).then(function (res) {
			return res.data;
		});
	};
});
...
angular.module('hackApp').directive('collection', function () {
    return {
        restrict: "E",
        replace: true,
        scope: {
...
angular.module('hackApp').controller('frontCtrl', function ($scope, apiService) {
...
angular.module('hackApp').controller('itemCtrl', function ($scope, apiService, $stateParams) {
...
angular.module('hackApp').directive('member', function ($compile) {
    return {
        restrict: "E",
        replace: true,
        scope: {
